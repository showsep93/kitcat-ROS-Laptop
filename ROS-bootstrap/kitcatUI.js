...
window.onload = function () {
    ...
    ros = new ROSLIB.Ros({
        url: "ws://" + "192.168.1.190" + ":9090" // Default port for a ROS bridge web socket
    });
    ...
    video.src = "http://" + "192.168.1.190" + ":8887/stream?topic=/raspicam_node/image&image_transport=compressed&type=mjpeg";
